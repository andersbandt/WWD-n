...
//! @author Anders Bandt
//! @brief Function prototypes for interfacing with the 'inv_imu_device' struct
//! @version 0.9
//! @date November 2023
//!
//*****************************************************************************
...
typedef struct inv_imu_device {
	 ...
	 */
	void (*sensor_event_cb)(inv_imu_sensor_event_t *evt);
...
/**
 * @brief Gets temperature data from IMU
 * @param[in] s  Pointer to device.
 */
